...
For the full syntax reference see [markdowns/spec.md](https://github.com/Hacknock/lobsterjs/blob/main/markdowns/spec.md) (English) or [markdowns/spec-ja.md](https://github.com/Hacknock/lobsterjs/blob/main/markdowns/styling-ja.md) (日本語).
...
an AI prompt template, see **[markdowns/styling.md](https://github.com/Hacknock/lobsterjs/blob/main/markdowns/styling.md)**.
...
| File                                                     | Style                                             |
| :------------------------------------------------------- | :------------------------------------------------ |
| [`docs/style.css`](https://github.com/Hacknock/lobsterjs/blob/main/docs/style.css)                     | **Default** — clean, minimal, light               |
| [`docs/themes/pop.css`](https://github.com/Hacknock/lobsterjs/blob/main/docs/themes/pop.css)           | **Pop** — bright, rounded, playful (coral/pink)   |
| [`docs/themes/pastel.css`](https://github.com/Hacknock/lobsterjs/blob/main/docs/themes/pastel.css)     | **Pastel** — soft, dreamy, gentle (lavender/mint) |
| [`docs/themes/formal.css`](https://github.com/Hacknock/lobsterjs/blob/main/docs/themes/formal.css)     | **Formal** — strict, professional, serif (navy)   |
| [`docs/themes/engineer.css`](https://github.com/Hacknock/lobsterjs/blob/main/docs/themes/engineer.css) | **Engineer** — dark, terminal-like, dev-tool feel |
...
[MIT](https://github.com/Hacknock/lobsterjs/blob/main/LICENSE) © 2022 Hacknock
